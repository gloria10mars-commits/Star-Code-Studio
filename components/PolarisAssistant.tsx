  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: userMsg,
        config: {
          systemInstruction: "Tu es Star Code Brain, l'assistant de STAR CODE STUDIO. Tu aides les créateurs à configurer et déployer leurs portails de ressources. Style : clair, technique, efficace. Réponds toujours en français.",
          temperature: 0.8,
        }
      });
          ...
          <div className="p-6 bg-gradient-to-r from-cyan-600 to-indigo-700 flex justify-between items-center shadow-lg">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[8px] font-black text-cyan-200/60 uppercase tracking-widest mt-1">lion d'astarte</span>
              </div>
            </div>
